    ...
    <main>
      <section className={classes.TwoColumn}>
        ...
        <p className={classes.Subtitle} style={{ paddingTop: '3rem' }}>
          We are a team of passionate UI/UX Designer, and we believe with the
          right design and strong collaboration, we can support your brand
          growth and help you fulfill your vision and goals.
        </p>
      </section>
